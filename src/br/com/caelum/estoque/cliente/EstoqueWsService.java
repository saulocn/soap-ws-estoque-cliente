 ...
 * 
 */
@WebServiceClient(name = "EstoqueWsService", targetNamespace = "http://ws.estoque.caelum.com.br/", wsdlLocation = "http://localhost:8086/soap-estoquews-web/estoquews?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8086/soap-estoquews-web/estoquews?wsdl");
    ...
    public IEstoqueWs getEstoqueWsPort() {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/", "EstoqueWsPort"), IEstoqueWs.class);
    }
     ...
     */
    @WebEndpoint(name = "EstoqueWsPort")
    public IEstoqueWs getEstoqueWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.estoque.caelum.com.br/", "EstoqueWsPort"), IEstoqueWs.class, features);
    }
